...
function ye(e, t) {
	switch (e.type) {
		...
		case "NGPipeExpression": return ye(e.left, t);
		case "MemberExpression":
		case "OptionalMemberExpression": return ye(e.object, t);
		case "TaggedTemplateExpression": return e.tag.type === "FunctionExpression" ? !1 : ye(e.tag, t);
		case "CallExpression":
		case "OptionalCallExpression": return e.callee.type === "FunctionExpression" ? !1 : ye(e.callee, t);
		case "ConditionalExpression": return ye(e.test, t);
		case "UpdateExpression": return !e.prefix && ye(e.argument, t);
		case "BindExpression": return e.object && ye(e.object, t);
		case "SequenceExpression": return ye(e.expressions[0], t);
		...
		case "SatisfiesExpression": return ye(e.expression, t);
		default: return t(e);
	}
}
function dr(e, t) {
...
function $n(e, t) {
	...
	} else if (t < 0 && (t = e.arguments.length + t), t >= 0 && t < e.arguments.length) return [
		...r,
		"arguments",
		t
	];
...
function es({ comment: e, precedingNode: t, enclosingNode: r, followingNode: n, text: s }) {
	...
	if (t === r.consequent && n === r.alternate) {
		...
		if (w(e) < o || r.alternate.type === "BlockStatement") return t.type === "BlockStatement" ? ($(t, e), !0) : Zn(e, s) && !ue(s, w(t), w(e)) ? ($(t, e), !0) : (we(r, e), !0);
	}
	...
	if (Mp(r)) {
		...
		if (n) {
			...
			for (let s of [
				...
				"extends",
				"mixins"
			]) if (r[s] && n === r[s][0]) return t && (t === r.id || t === r.typeParameters || t === r.superClass) ? $(t, e) : we(r, e, s), !0;
		}
	}
	return !1;
}
...
function Jp({ comment: e, precedingNode: t, enclosingNode: r, followingNode: n, text: s }) {
	return t?.type === "ComponentTypeParameter" && (r?.type === "DeclareComponent" || r?.type === "ComponentTypeAnnotation") && n?.type !== "ComponentTypeParameter" ? ($(t, e), !0) : (t?.type === "ComponentParameter" || t?.type === "RestElement") && r?.type === "ComponentDeclaration" && _e(s, I(e)) === ")" ? ($(t, e), !0) : !1;
}
	...
	for (; s.length > 0;) {
		...
		if (t?.(i) !== !1) switch (o) {
			...
			case Me: {
				...
				for (let c = u.length - 1; c >= 0; --c) s.push(u[c]);
				break;
			}
			case be:
	...
	function s(i) {
		switch (We(i)) {
			...
			case Fe: {
				...
				return o ? (o = o.map(n), u = o[0]) : u = n(u), t({
					...i,
					contents: u,
					expandedStates: o
				});
...
function l(e, t = {}) {
	return de(e), Kr(t.expandedStates, !0), {
		type: Fe,
		id: t.id,
		contents: e,
		break: !!t.shouldBreak,
...
function to(e, t, r) {
	...
	let n;
	return typeof t == "number" ? t < 0 ? n = gc : n = {
		type: 2,
		width: t
	} : n = {
		type: 3,
	...
	for (; r >= 0;) {
		...
		switch (F) {
			...
			case Me: {
				...
				for (let b = C.length - 1; b >= d; b--) p.push({
					mode: y,
					doc: C[b]
				});
				break;
...
function ls(e, t) {
	let r = Object.create(null), n = t.printWidth, s = Zi(t.endOfLine), i = 0, o = [{
		indent: as,
		mode: ve,
		doc: e
	}], u = "", p = !1, c = [], y = [], D = [], F = [], C = 0;
...
`, s) : S;
			...
			case Be:
				for (let j = S.length - 1; j >= 0; j--) o.push({
					indent: h,
					mode: g,
					doc: S[j]
				});
	...
	return {
		formatted: d,
		cursorNodeStart: B,
		cursorNodeText: d.slice(B, N(0, b, -1))
	};
	function O() {
...
function io(e, t, r) {
	...
	return o && (ue(t.originalText, I(s.typeArguments ?? s.tag), w(o)) ? i = f : i = " "), pt(n.label && {
		tagged: !0,
		...n.label
	}, [
		r("tag"),
...
`) && u.push({
		...
		return [
			je,
			"`",
			m([E, L(E, y.map((D) => L(" | ", D.cells.map((F, C) => D.hasLineBreak ? F : F + " ".repeat(c[C] - ot(F))))))]),
			E,
			"`"
		];
	}
...
async function ao(e, t, r) {
	...
	let u = Lc(await e(s, { parser: "scss" }), zt(r, t));
...
function Oc(e) {
	return e.match(void 0, (t, r) => r === "quasi" && t.type === "TaggedTemplateExpression" && Pt(t.tag, [
		"css",
		"css.global",
		"css.resolve"
...
function wc({ parent: e }) {
	...
	switch (t.type) {
		case "MemberExpression": return nn(t.object) || uo(t);
		case "CallExpression": return nn(t.callee) || t.callee.type === "MemberExpression" && (t.callee.object.type === "MemberExpression" && (nn(t.callee.object.object) || uo(t.callee.object)) || t.callee.object.type === "CallExpression" && nn(t.callee.object.callee));
...
async function mo(e, t, r, n, s) {
	let { node: i } = n, o = Es;
	Es = Es + 1 >>> 0;
	let u = (O) => `PRETTIER_HTML_PLACEHOLDER_${O}_${o}_IN_JS`, p = i.quasis.map((O, h, g) => h === g.length - 1 ? O.value.cooked : O.value.cooked + u(h)).join(""), c = zt(n, r), y = new RegExp(u("(\\d+)"), "gu"), D = 0, C = ft(await t(p, {
		parser: e,
		__onHtmlRoot(O) {
			D = O.children.length;
		}
...
`);
	...
	let n = Object.create(null), s = W(0, e, To, "").replace(Ao, "").trimEnd(), i;
	for (; i = To.exec(e);) {
		let o = W(0, i[2], qc, "");
...
function Xc(e) {
	...
	let { pragmas: n, comments: s } = bo(So(e));
	return {
		shebang: t,
		text: e,
		pragmas: n,
...
function Lo(e) {
	let { shebang: t, text: r, pragmas: n, comments: s } = Xc(e), i = Bo(r), o = Po({
		pragmas: {
			[ko]: "",
			...n
		},
...
`);
	return [
		"/*",
		L(E, t.map((r, n) => n === 0 ? r.trimEnd() : " " + (n < t.length - 1 ? r.trim() : r.trimStart()))),
		"*/"
	];
}
function ds(e, t) {
	...
	switch (s.type) {
		...
		case "ClassExpression":
			...
			break;
		case "ExportDefaultDeclaration": return _o(e, t) || r.type === "SequenceExpression";
		case "Decorator":
	...
	switch (r.type) {
		...
		case "LogicalExpression": switch (s.type) {
			...
			case "AsExpression":
			case "AsConstExpression":
			case "SatisfiesExpression": return !Ae(r);
			case "ConditionalExpression": return Ae(r) || fi(r);
			case "CallExpression":
			case "NewExpression":
			case "OptionalCallExpression": return n === "callee";
			case "ClassExpression":
			...
			case "OptionalMemberExpression": return n === "object";
			case "AssignmentExpression":
			case "AssignmentPattern": return n === "left" && (r.type === "TSTypeAssertion" || Ae(r));
		...
		case "SequenceExpression": return s.type !== "ForStatement";
		...
		case "TSFunctionType": if (e.match((i) => i.type === "TSFunctionType", (i, o) => o === "typeAnnotation" && i.type === "TSTypeAnnotation", (i, o) => o === "returnType" && i.type === "ArrowFunctionExpression")) return !0;
		...
		case "TSUnionType":
		case "TSIntersectionType": if (Se(s) || xt(s)) return !0;
		...
		case "UnionTypeAnnotation": return s.type === "TypeOperator" || s.type === "KeyofTypeAnnotation" || s.type === "ArrayTypeAnnotation" || s.type === "NullableTypeAnnotation" || s.type === "IntersectionTypeAnnotation" || s.type === "UnionTypeAnnotation" || n === "objectType" && (s.type === "IndexedAccessType" || s.type === "OptionalIndexedAccessType");
		...
		case "AssignmentExpression": return !((n === "init" || n === "update") && s.type === "ForStatement" || n === "expression" && r.left.type !== "ObjectPattern" && s.type === "ExpressionStatement" || n === "key" && s.type === "TSPropertySignature" || s.type === "AssignmentExpression" || n === "expressions" && s.type === "SequenceExpression" && e.match(void 0, void 0, (i, o) => (o === "init" || o === "update") && i.type === "ForStatement") || n === "value" && s.type === "Property" && e.match(void 0, void 0, (i, o) => o === "properties" && i.type === "ObjectPattern") || s.type === "NGChainedExpression" || n === "node" && s.type === "JsExpressionRoot");
		...
		case "ArrowFunctionExpression": switch (s.type) {
			case "BinaryExpression": return s.operator !== "|>" || r.extra?.parenthesized;
			case "NewExpression":
			case "CallExpression":
			case "OptionalCallExpression": return n === "callee";
			case "MemberExpression":
		...
		case "CallExpression":
		case "MemberExpression": if (tl(e)) return !0;
		case "TaggedTemplateExpression":
		case "TSNonNullExpression":
			...
			return !1;
		case "BindExpression": return n === "callee" && (s.type === "BindExpression" || s.type === "NewExpression") || n === "object" && J(s);
		case "NGPipeExpression": return !(s.type === "NGRoot" || s.type === "NGMicrosyntaxExpression" || s.type === "ObjectProperty" && !r.extra?.parenthesized || q(s) || n === "arguments" && M(s) || n === "right" && s.type === "NGPipeExpression" || n === "property" && s.type === "MemberExpression" || s.type === "AssignmentExpression");
		case "JSXFragment":
		case "JSXElement": return n === "callee" || n === "left" && s.type === "BinaryExpression" && s.operator === "<" || !q(s) && s.type !== "ArrowFunctionExpression" && s.type !== "AssignmentExpression" && s.type !== "AssignmentPattern" && s.type !== "BinaryExpression" && s.type !== "NewExpression" && s.type !== "ConditionalExpression" && s.type !== "ExpressionStatement" && s.type !== "JsExpressionRoot" && s.type !== "JSXAttribute" && s.type !== "JSXElement" && s.type !== "JSXExpressionContainer" && s.type !== "JSXFragment" && s.type !== "LogicalExpression" && !M(s) && !Oe(s) && s.type !== "ReturnStatement" && s.type !== "ThrowStatement" && s.type !== "TypeCastExpression" && s.type !== "VariableDeclarator" && s.type !== "YieldExpression" && s.type !== "MatchExpressionCase";
		case "TSInstantiationExpression": return n === "object" && J(s);
		case "MatchOrPattern": return s.type === "MatchAsPattern";
	}
	return !1;
}
function zc(e) {
...
function ol(e, t, r) {
	...
	if (r?.hasLineSuffix && !r?.isBlock || Z(o, u(n), { backwards: !0 })) return {
		doc: us([
			E,
			Mo(o, u(n)) ? E : "",
			s
...
function Mt(e, t) {
	...
	if ((r.comments || []).filter((p) => !n.has(p)).length === 0) return {
		leading: "",
		trailing: ""
	};
	let i = [], o = [], u;
...
function Ke(e, t, r, n, s) {
	...
	if (o.length === 0) return [
		u,
		"(",
		v(e, t, { filter: (d) => _e(t.originalText, I(d)) === ")" }),
		")"
	];
	...
	return y && F ? [
		...
		...D,
		")"
	] : (Gr(p) || Ei(p) || p.type === "TypeAlias" || p.type === "UnionTypeAnnotation" || p.type === "IntersectionTypeAnnotation" || p.type === "FunctionTypeAnnotation" && p.returnType === i) && o.length === 1 && o[0].name === null && i.this !== o[0] && o[0].typeAnnotation && i.typeParameters === null && Vt(o[0].typeAnnotation) && !i.rest ? t.arrowParens === "always" || i.type === "HookTypeAnnotation" ? [
		"(",
		...D,
		")"
	] : D : [
...
function on(e, t, r) {
	...
	if (!C) return h;
	return l([h, yt(N(0, c, -1), { groupId: O })]);
}
function Ts(e, t, r, n, s) {
	...
	let u = er(i), p = i.right.type === "ChainExpression" ? i.right.expression : i.right, c = (i.operator === "|>" || i.type === "NGPipeExpression" || yl(e, t)) && !Ee(t.originalText, p), D = !T(p, x.Leading, Hr) && Ee(t.originalText, p), F = i.type === "NGPipeExpression" ? "|" : i.operator, C = i.type === "NGPipeExpression" && i.arguments.length > 0 ? l(m([
		f,
		": ",
		L([A, ": "], e.map(() => xe(2, l(r())), "arguments"))
	])) : "", d;
	if (u) d = [F, Ee(t.originalText, p) ? m([
		A,
		r("right"),
		C
	]) : [
...
function un(e, t, r) {
	...
	if (Yr(e) && ({leading: p, trailing: c} = Mt(e, t)), o) return [
		p,
		L(" | ", u),
		c
	];
	let D = [P([i && !Ee(t.originalText, n) ? A : "", "| "]), L([A, "| "], u)];
	if (ge(e, t)) return [
		p,
		l([m(D), f]),
		c
	...
	let F = [p, l(D)];
	return (s.type === "TupleTypeAnnotation" || s.type === "TSTupleType") && s[s.type === "TupleTypeAnnotation" && s.types ? "types" : "elementTypes"].length > 1 ? [l([
		m([P(["(", f]), F]),
		f,
		P(")")
	]), c] : [l(i ? m(F) : F), c];
...
function tr(e, t, r) {
	...
	if (p.length === 0) s.push(Al(e, t, i, o));
		...
		s.push(l([
			...
			m([
				f,
				d ? xl(e, t, r, b) : [Tl(e, t, r, u, n.inexact), b],
				v(e, t)
			]),
			f,
			o
...
function Xo(e, t, r) {
	...
	function o() {
		...
		if (M(_) && (Tt(_.callee) || M(_.callee))) {
			...
			node: _,
			needsParens: ge(e, t),
			printed: De(e, J(_) ? Ss(e, t, r) : hs(e, t, r), t)
		}), e.call(o, "object")) : _.type === "TSNonNullExpression" ? (s.unshift({
			node: _,
			printed: De(e, "!", t)
		}), e.call(o, "expression")) : s.unshift({
			node: _,
			printed: r()
		});
	}
	...
	function B(_) {
		...
		return _.length > 0 && N(0, _, -1).needsParens ? [
			"(",
			...re,
			")"
		] : re;
	...
	let fe = N(0, p[b ? 1 : 0], -1).node, Y = !M(fe) && i(fe), z = [
		B(p[0]),
		b ? p.slice(1, 2).map(B) : "",
		Y ? E : "",
		O(p.slice(b ? 2 : 1))
	], ee = s.map(({ node: _ }) => _).filter(M);
	function Ie() {
...
function Ml(e, t, r, n) {
	...
	switch (s.type) {
		...
		case "ClassExpression": return R(s.decorators);
	}
	if (n) return !1;
	let i = s, o = [];
...
function mn(e, t, r, n) {
	...
	let o = [
		...
		s.id ? r("id") : ""
	], u = Ke(e, t, r, i), p = rr(e, r), c = lt(s, p);
...
function su(e, t, r) {
	...
	if (n.argument) {
		...
		Xl(t, n.argument) ? u = [
			...
			E,
			")"
		] : (Te(n.argument) || t.experimentalTernaries && n.argument.type === "ConditionalExpression" && (n.argument.consequent.type === "ConditionalExpression" || n.argument.alternate.type === "ConditionalExpression")) && (u = l([
			P("("),
			m([f, u]),
			f,
			P(")")
...
function Vl(e, t, r) {
	...
	n.children = n.children.map((g) => cm(g) ? {
		type: "JSXText",
		value: " ",
		raw: " "
	} : g);
	let o = n.children.some(H), u = n.children.filter((g) => g.type === "JSXExpressionContainer").length > 1, p = n.type === "JSXElement" && n.openingElement.attributes.length > 1, c = ne(s) || o || p || u, y = e.parent.rootMarker === "mdx", D = t.singleQuote ? "{' '}" : "{\" \"}", F = y ? A : P([D, f], " "), d = $l(e, t, r, F, n.openingElement?.name?.name === "fbt"), b = n.children.some((g) => Br(g));
	...
	if (t.cursorNode?.type === "JSXText" && n.children.includes(t.cursorNode) ? O = [
		Tr,
		O,
		Tr
	] : t.nodeBeforeCursor?.type === "JSXText" && n.children.includes(t.nodeBeforeCursor) ? O = [Tr, O] : t.nodeAfterCursor?.type === "JSXText" && n.children.includes(t.nodeAfterCursor) && (O = [O, Tr]), y) return O;
	let h = l([
		s,
		m([E, O]),
		E,
...
function Zl(e, t, r) {
	...
	if (n.value) {
		let i;
		if (V(n.value)) {
			let u = W(0, W(0, pe(n.value).slice(1, -1), "&apos;", "'"), "&quot;", "\""), p = wr(u, t.jsxSingleQuote);
...
function mu(e, t, r) {
	...
	if (n.type.startsWith("JSX")) switch (n.type) {
		case "JSXAttribute": return Zl(e, t, r);
		...
		case "JSXSpreadAttribute":
		case "JSXSpreadChild": return am(e, t, r);
		case "JSXExpressionContainer": return em(e, t, r);
		case "JSXFragment":
		case "JSXElement": return om(e, t, r);
		case "JSXOpeningElement": return tm(e, t, r);
		case "JSXClosingElement": return sm(e, t, r);
		case "JSXOpeningFragment":
		case "JSXClosingFragment": return im(e, t);
		case "JSXEmptyExpression": return um(e, t);
		case "JSXText": throw new Error("JSXText should be handled by JSXElement");
		default: throw new Qe(n, "JSX");
	}
}
function pm(e) {
...
function yu(e, t, r) {
	...
	if (n.type.startsWith("NG")) switch (n.type) {
		...
		case "NGPipeExpression": return on(e, t, r);
		case "NGChainedExpression": return l(L([";", A], e.map(() => fm(e) ? r() : [
			"(",
			r(),
			")"
		], "expressions")));
		case "NGEmptyExpression": return "";
		case "NGMicrosyntax": return e.map(() => [e.isFirst ? "" : fu(e) ? " " : [";", A], r()], "body");
		...
		default: throw new Qe(n, "Angular");
	}
}
...
function Fu(e, t, r) {
	...
	return [
		e.key === "declaration" && Di(s) ? E : o ? ke : "",
		L(A, e.map(r, "decorators")),
		A
	];
}
function du(e, t) {
...
function Tu(e, t, r, n = {}) {
	...
	let y = !Ee(t.originalText, c) && (ym(c) || Fm(c, i, t) || !u && Au(c)), D = e.key === "callee" && Dt(e.parent), F = Symbol("arrow-chain"), C = dm(e, n, {
		signatureDocs: s,
		shouldBreak: u
	}), d = !1, b = !1, B = !1;
	return p && (D || n.assignmentLayout) && (b = !0, B = !T(e.node, x.Leading & x.Line), d = n.assignmentLayout === "chain-tail-arrow-chain" || D && !y), i = Cm(e, t, n, {
		bodyDoc: i,
		bodyComments: o,
		functionBody: c,
...
function dm(e, t, { signatureDocs: r, shouldBreak: n }) {
	...
	return i !== "callee" && Dt(s) || Te(s) ? l([
		r[0],
		" =>",
		m([A, L([" =>", A], r.slice(1))])
	], { shouldBreak: n }) : i === "callee" && Dt(s) || t.assignmentLayout ? l(L([" =>", A], r), { shouldBreak: n }) : l(m(L([" =>", A], r)), { shouldBreak: n });
}
...
function Rt(e, t, r) {
	...
	if (hm(e, ({ node: F, next: C, isLast: d }) => {
		...
		!o && (Sm({
			...
			node: F,
			next: C
		}, t)) && s.push(";"), d || (s.push(u), oe(F, t) && s.push(E));
...
function hm(e, t) {
	...
	if (r.type === "ObjectTypeAnnotation") {
		let n = [
			...
			"callProperties",
			"internalSlots"
		].flatMap((s) => e.map(({ node: i, index: o }) => ({
			node: i,
			loc: w(i),
			selector: [s, o]
		}), s)).sort((s, i) => s.loc - i.loc);
		for (let [s, { node: i, selector: o }] of n.entries()) e.call(() => t({
			node: i,
			next: n[s + 1]?.node,
			isLast: s === n.length - 1
		}), ...o);
...
function he(e, t) {
	let { parent: r } = e;
	return e.callParent(Su) ? t.semi || r.type === "ObjectTypeAnnotation" ? ";" : "" : r.type === "TSTypeLiteral" ? e.isLast ? t.semi ? P(";") : "" : t.semi || bu({
		node: e.node,
		next: e.next
	}, t) ? ";" : P("", ";") : "";
}
...
function bu({ node: e, next: t }, r) {
	...
	if (!t) return !1;
	switch (t.type) {
		case "TSCallSignatureDeclaration": return !0;
	}
	return !1;
}
function sr(e, t, r) {
...
function km(e) {
	return e.type === "ObjectTypeAnnotation" ? [
		"properties",
		"indexers",
		"callProperties",
		"internalSlots"
	].some((t) => R(e[t])) : R(e.body);
}
function Pu(e) {
...
function Lm(e, t, r) {
	...
	return s.type === "AssignmentExpression" ? l(P([
		"(",
		m([f, n]),
		f,
		")"
...
function Nu(e, t) {
	let { node: r } = e;
	switch (r.type) {
		case "RegExpLiteral": return _u(r);
		case "BigIntLiteral": return Cn(r.extra.raw);
		case "NumericLiteral": return dt(r.extra.raw);
		case "StringLiteral": return qe(ut(r.extra.raw, t));
		case "NullLiteral": return "null";
		case "BooleanLiteral": return String(r.value);
		case "DirectiveLiteral": return Mu(r.extra.raw, t);
		case "Literal": {
...
function ir(e, t, r) {
	...
	if (p) {
		...
		if (T(n, x.Dangling)) {
			...
			B = [
				v(e, t),
				O || Z(t.originalText, I(N(0, et(n), -1))) ? E : A,
				"..."
			];
		} else B = ["..."];
		C.push([...F, ...B]);
...
function Gu(e, t, r) {
	...
	if (R(n.specifiers)) {
		...
		}, "specifiers"), s.push(L(", ", i)), o.length > 0 && (i.length > 0 && s.push(", "), o.length > 1 || i.length > 0 || n.specifiers.some((p) => T(p)) ? s.push(l([
			"{",
			m([t.bracketSpacing ? A : f, L([",", A], o)]),
			P(ie(t) ? "," : ""),
...
function Uu(e, t, r) {
	...
	return s === "ExportNamespaceSpecifier" || s === "ImportNamespaceSpecifier" ? y = "*" : p && (y = r(o)), c && !Um(n) && (D = r(u)), [
		Js(s === "ImportSpecifier" ? n.importKind : n.exportKind, !1),
		y,
		y && D ? " as " : "",
		D
	];
...
function Hm(e, t, r) {
	let { node: n } = e, s = n.type === "ConditionalExpression", i = s ? "alternate" : "falseType", { parent: o } = e, u = s ? r("test") : [
		r("checkType"),
		" ",
		"extends",
		" ",
...
function Yu(e, t, r) {
	...
	if (s && (H(n[u[0]]) || H(p) || H(c) || Ym(g))) {
		...
		let Y = (ee) => [
			...
			f,
			P(")")
		], z = (ee) => ee.type === "NullLiteral" || ee.type === "Literal" && ee.value === null || ee.type === "Identifier" && ee.name === "undefined";
		y.push(" ? ", z(p) ? r(i) : Y(r(i)), " : ", c.type === n.type || z(c) ? r(o) : Y(r(o)));
	} else {
		let Y = (ee) => t.useTabs ? m(r(ee)) : xe(2, r(ee)), z = [
			A,
			"? ",
			p.type === n.type ? P("", "(") : "",
			Y(i),
	...
	let S = (Y) => F === h ? l(Y) : Y, j = !D && (J(F) || F.type === "NGPipeExpression" && F.left === n) && !F.computed, U = Vm(e), fe = S([
		Hm(e, t, r),
		d ? y : m(y),
		s && j && !U ? f : ""
	]);
...
function ur(e, t, r, n) {
	...
	let Vs = Symbol("test"), xa = Symbol("consequent"), kr = Symbol("test-and-consequent"), $s = l([i ? [Ws(r("test")), s.test.type === "ConditionalExpression" ? ke : ""] : [
		r("checkType"),
		" ",
		"extends",
		" ",
		Ue(s.extendsType) || s.extendsType.type === "TSMappedType" ? r("extendsType") : l(Ws(r("extendsType")))
	], " ?"], { id: Vs }), ha = r(u), Ir = m([
		O || Ie && (H(y) || d || g) ? E : A,
		Pr,
		ha
	]), Sa = Mn ? l([$s, g ? Ir : P(Ir, l(Ir, { id: xa }), { groupId: Vs })], { id: kr }) : [$s, Ir], Nn = r(p), Ks = Bt ? P(Nn, Qr(Ws(Nn)), { groupId: kr }) : Nn, lr = [
		Sa,
		cr.length > 0 ? [m([E, cr]), E] : h ? E : Bt ? P(A, " ", { groupId: kr }) : A,
		":",
		h ? " " : S ? Mn ? P(ae, P(g || Bt ? " " : ae, " "), { groupId: kr }) : P(ae, " ") : " ",
		h ? Ks : l([m(Ks), Ie && !Bt ? f : ""]),
		_ && !st ? f : "",
		it ? ke : ""
	];
...
function Hu(e, t, r, n) {
	...
	switch (s.type) {
		...
		case "File": return wu(e, t, r) ?? r("program");
		case "ExpressionStatement": return Ou(e, t, r);
		case "ChainExpression": return r("expression");
		case "ParenthesizedExpression": return !T(s.expression) && (se(s.expression) || q(s.expression)) ? [
			"(",
			r("expression"),
			")"
		] : l([
		...
		case "AssignmentExpression": return zo(e, t, r);
		case "VariableDeclarator": return Zo(e, t, r);
		case "BinaryExpression":
		case "LogicalExpression": return on(e, t, r);
		...
		case "OptionalMemberExpression":
		case "MemberExpression": return Ho(e, t, r);
		case "MetaProperty": return [
			r("meta"),
			".",
			r("property")
		];
		case "BindExpression": return Yo(e, t, r);
		...
		case "SpreadElement": return or(e, r);
		case "RestElement": return or(e, r);
		case "FunctionDeclaration":
		case "FunctionExpression": return mn(e, t, r, n);
		case "ArrowFunctionExpression": return Tu(e, t, r, n);
		case "YieldExpression": return [`yield${s.delegate ? "*" : ""}`, s.argument ? [" ", r("argument")] : ""];
		case "AwaitExpression": {
			let i = ["await"];
			if (s.argument) {
				i.push(" ", r("argument"));
		...
		case "ExportAllDeclaration": return An(e, t, r);
		case "ImportDeclaration": return vu(e, t, r);
		case "ImportSpecifier":
		case "ExportSpecifier":
		case "ImportNamespaceSpecifier":
		case "ExportNamespaceSpecifier":
		case "ImportDefaultSpecifier":
		case "ExportDefaultSpecifier": return Uu(e, t, r);
		case "ImportAttribute": return ln(e, t, r);
		case "Program":
		case "BlockStatement":
		case "StaticBlock": return En(e, t, r);
		case "ClassBody": return Rt(e, t, r);
		case "ThrowStatement": return ou(e, t, r);
		case "ReturnStatement": return iu(e, t, r);
		case "NewExpression":
		case "ImportExpression":
		case "OptionalCallExpression":
		case "CallExpression": return vt(e, t, r);
		case "ObjectExpression":
		case "ObjectPattern": return ir(e, t, r);
		case "Property": return mt(s) ? Sr(e, t, r) : ln(e, t, r);
		case "ObjectProperty": return ln(e, t, r);
		case "ObjectMethod": return Sr(e, t, r);
		case "Decorator": return ["@", r("expression")];
		case "ArrayExpression":
		case "ArrayPattern": return tr(e, t, r);
		...
		case "Directive": return [r("value"), t.semi ? ";" : ""];
		case "UnaryExpression": {
			let i = [s.operator];
			return /[a-z]$/u.test(s.operator) && i.push(" "), T(s.argument) ? i.push(l([
				"(",
				m([f, r("argument")]),
				f,
				")"
		...
		case "ConditionalExpression": return ur(e, t, r, n);
		case "VariableDeclaration": {
			...
			return i.length === 1 && !T(s.declarations[0]) ? c = i[0] : i.length > 0 && (c = m(i[0])), l([
				Q(e),
				s.kind,
				c ? [" ", c] : "",
				m(i.slice(1).map((y) => [
		...
		case "IfStatement": {
			let i = Ft(s.consequent, r("consequent")), u = [l([
				"if (",
				l([m([f, r("test")]), f]),
				")",
				i
		...
		case "ForStatement": {
			...
			return !s.init && !s.test && !s.update ? [u, l(["for (;;)", i])] : [u, l([
				"for (",
				l([m([
					f,
					r("init"),
		...
		case "DoWhileStatement": return [
			l(["do", Ft(s.body, r("body"))]),
			s.body.type === "BlockStatement" ? " " : E,
			"while (",
			l([m([f, r("test")]), f]),
			")",
			t.semi ? ";" : ""
		...
		case "ContinueStatement": return [
			s.type === "BreakStatement" ? "break" : "continue",
			s.label ? [" ", r("label")] : "",
			t.semi ? ";" : ""
		];
		case "LabeledStatement": return [
			r("label"),
			`:${s.body.type === "EmptyStatement" && !T(s.body, x.Leading) ? "" : " "}`,
			r("body")
		];
		...
		case "SwitchStatement": return [
			...
			" {",
			s.cases.length > 0 ? m([E, L(E, e.map(({ node: i, isLast: o }) => [r(), !o && oe(i, t) ? E : ""], "cases"))]) : "",
			E,
			"}"
		];
		case "SwitchCase": {
		...
		case "DebuggerStatement": return ["debugger", t.semi ? ";" : ""];
		case "ClassDeclaration":
		case "ClassExpression": return sr(e, t, r);
		case "ClassMethod":
		case "ClassPrivateMethod":
		case "MethodDefinition": return Fn(e, t, r);
		case "ClassProperty":
		case "PropertyDefinition":
		case "ClassPrivateProperty":
		case "ClassAccessorProperty":
		case "AccessorProperty": return dn(e, t, r);
		case "TemplateElement": return qe(s.value.raw);
		case "TemplateLiteral": return en(e, t, r);
		case "TaggedTemplateExpression": return io(e, t, r);
		...
		case "EmptyStatement": if (kt(e)) return ";";
		default: throw new Qe(s, "ESTree");
	}
}
function Tn(e) {
...
function Xu(e, t, r) {
	...
	return n.rendersType ? s.push(l([
		...
		" ",
		r("rendersType")
	])) : s.push(l([i])), n.body && s.push(" ", r("body")), t.semi && n.type === "DeclareComponent" && s.push(";"), s;
}
function eD(e, t, r) {
	let { node: n } = e, s = n.params;
	if (n.rest && (s = [...s, n.rest]), s.length === 0) return [
		"(",
		v(e, t, { filter: (o) => _e(t.originalText, I(o)) === ")" }),
		")"
	];
	let i = [];
	return rD(e, (o, u) => {
...
function Pn(e, t, r) {
	...
	return l(e.map(({ isFirst: s, previous: i, node: o, index: u }) => {
		...
		if (s) return p;
		let c = Je(o), y = Je(i);
		return y && c ? [" & ", n ? m(p) : p] : !y && !c || Ee(t.originalText, o) ? t.experimentalOperatorPosition === "start" ? m([
			A,
			"& ",
			p
		]) : m([
...
function na(e, t, r) {
	...
	return l([
		...
		m([
			t.bracketSpacing ? A : f,
			T(n, x.Dangling) ? l([v(e, t), E]) : "",
			l([
				n.readonly ? [ta(n.readonly, "readonly"), " "] : "",
				"[",
				r("key"),
				" in ",
				r("constraint"),
...
function sa(e, t, r) {
	...
	return [
		...
		" {",
		n.cases.length > 0 ? m([E, L(E, e.map(({ node: s, isLast: i }) => [r(), !i && oe(s, t) ? E : ""], "cases"))]) : "",
		E,
		"}"
	];
}
function ia(e, t, r) {
	let { node: n } = e, s = T(n, x.Dangling) ? [" ", v(e, t)] : [], i = n.type === "MatchStatementCase" ? [" ", r("body")] : m([
		A,
		r("body"),
		","
	]);
...
function oa(e, t, r) {
	let { node: n } = e;
	switch (n.type) {
		case "MatchOrPattern": return uD(e, t, r);
		...
		case "MatchMemberPattern": {
			let s = n.property.type === "Identifier" ? [".", r("property")] : [
				"[",
				m([f, r("property")]),
				f,
				"]"
		...
		case "MatchObjectPatternProperty": return n.shorthand ? r("pattern") : l([
			r("key"),
			":",
			m([A, r("pattern")])
		]);
...
function uD(e, t, r) {
	...
	if (o) return L(" | ", u);
	let p = [P(["| "]), L([A, "| "], u)];
	return ge(e, t) ? l([m([P([f]), p]), f]) : s.type === "MatchArrayPattern" && s.elements.length > 1 ? l([
		m([P(["(", f]), p]),
		f,
		P(")")
	]) : l(i ? m(p) : p);
...
function Ln(e, t, r) {
	...
	return [ht(e, t, r, [
		...
		r("id"),
		r("typeParameters")
	], " =", n.type === "TSTypeAliasDeclaration" ? "typeAnnotation" : "right"), t.semi ? ";" : ""];
}
function aD(e, t, r) {
	let { node: n } = e;
	return K(n).length === 1 && n.type.startsWith("TS") && !n[r][0].constraint && e.parent.type === "ArrowFunctionExpression" && !(t.filepath && t.filepath.endsWith('.ts'));
}
function Gt(e, t, r, n) {
	let { node: s } = e;
	if (!s[n]) return "";
	...
	if (s[n].length === 0 || !o && (i || s[n].length === 1 && (s[n][0].type === "NullableTypeAnnotation" || Jo(s[n][0])))) return [
		"<",
		L(", ", e.map(r, n)),
		pD(e, t),
		">"
...
function pa(e, t, r) {
	...
	switch (n.type) {
		...
		case "ComponentTypeAnnotation": return Xu(e, t, r);
		case "ComponentParameter": return Vu(e, t, r);
		case "ComponentTypeParameter": return $u(e, t, r);
		case "HookDeclaration": return zu(e, t, r);
		case "DeclareHook": return Zu(e, t, r);
		case "HookTypeAnnotation": return ea(e, t, r);
		...
		case "DeclareExportAllDeclaration": return An(e, t, r);
		case "DeclareOpaqueType":
		case "OpaqueType": return aa(e, t, r);
		case "DeclareTypeAlias":
		case "TypeAlias": return Ln(e, t, r);
		case "IntersectionTypeAnnotation": return Pn(e, t, r);
		case "UnionTypeAnnotation": return un(e, t, r);
		case "ConditionalTypeAnnotation": return ur(e, t, r);
		case "InferTypeAnnotation": return bn(e, t, r);
		case "FunctionTypeAnnotation": return Sn(e, t, r);
		case "TupleTypeAnnotation": return tr(e, t, r);
		case "TupleTypeLabeledElement": return In(e, t, r);
		case "TupleTypeSpreadElement": return kn(e, t, r);
		case "GenericTypeAnnotation": return [r("id"), Gt(e, t, r, "typeParameters")];
		case "IndexedAccessType":
		case "OptionalIndexedAccessType": return Bn(e, t, r);
		case "TypeAnnotation": return an(e, t, r);
		case "TypeParameter": return On(e, t, r);
		case "TypeofTypeAnnotation": return _n(e, r);
		case "ExistsTypeAnnotation": return "*";
		case "ArrayTypeAnnotation": return Tn(r);
		case "DeclareEnum":
		case "EnumDeclaration": return hn(e, r);
		case "EnumBooleanBody":
		case "EnumNumberBody":
		case "EnumBigIntBody":
		case "EnumStringBody":
		case "EnumSymbolBody": return Ku(e, t, r);
		case "EnumBooleanMember":
		case "EnumNumberMember":
		case "EnumBigIntMember":
		case "EnumStringMember":
		case "EnumDefaultedMember": return gn(e, r);
		...
		case "InterfaceTypeAnnotation": return sr(e, t, r);
		case "ObjectTypeAnnotation": return Rt(e, t, r);
		...
		case "ObjectTypeMappedTypeProperty": return ra(e, t, r);
		...
		case "ObjectTypeProperty": {
			let s = "";
			return n.proto ? s = "proto " : n.static && (s = "static "), [
				s,
				n.kind !== "init" ? n.kind + " " : "",
				n.variance ? r("variance") : "",
				Ct(e, t, r),
		...
		case "ObjectTypeSpreadProperty": return or(e, r);
		...
		case "StringLiteralTypeAnnotation": return qe(ut(pe(n), t));
		case "NumberLiteralTypeAnnotation": return dt(pe(n));
		case "BigIntLiteralTypeAnnotation": return Cn(pe(n));
		...
		case "TypePredicate": return wn(e, r);
		...
		case "TypeParameterInstantiation": return Gt(e, t, r, "params");
		...
		case "AsExpression":
		case "AsConstExpression":
		case "SatisfiesExpression": return xn(e, t, r);
		case "MatchExpression":
		case "MatchStatement": return sa(e, t, r);
		case "MatchExpressionCase":
		case "MatchStatementCase": return ia(e, t, r);
		case "MatchOrPattern":
		case "MatchAsPattern":
		...
		case "MatchRestPattern":
		case "MatchArrayPattern": return oa(e, t, r);
	}
}
function ca(e, t, r) {
	let { node: n } = e, s = n.parameters.length > 1 ? P(ie(t) ? "," : "") : "", i = l([
		m([f, L([", ", f], e.map(r, "parameters"))]),
		s,
		f
	]);
	return [
...
function ma(e, t, r) {
	...
	return [
		...
		r("id"),
		n.body ? [" ", l(r("body"))] : t.semi ? ";" : ""
	];
}
function Da(e, t, r) {
	let { node: n } = e, s = !(q(n.expression) || se(n.expression)), i = l([
		"<",
		m([f, r("typeAnnotation")]),
		f,
		">"
	]), o = [
		P("("),
...
function fa(e, t, r) {
	...
	if (n.type.startsWith("TS")) {
		...
		switch (n.type) {
			...
			case "TSTypeAssertion": return Da(e, t, r);
			case "TSDeclareFunction": return mn(e, t, r);
			case "TSExportAssignment": return [
				"export = ",
				r("expression"),
				t.semi ? ";" : ""
			];
			case "TSModuleBlock": return En(e, t, r);
			case "TSInterfaceBody":
			case "TSTypeLiteral": return Rt(e, t, r);
			case "TSTypeAliasDeclaration": return Ln(e, t, r);
			...
			case "TSAbstractMethodDefinition":
			case "TSDeclareMethod": return Fn(e, t, r);
			case "TSAbstractAccessorProperty":
			case "TSAbstractPropertyDefinition": return dn(e, t, r);
			case "TSInterfaceHeritage":
			case "TSClassImplements":
			case "TSInstantiationExpression": return [r("expression"), r("typeArguments")];
			case "TSTemplateLiteralType": return en(e, t, r);
			case "TSNamedTupleMember": return In(e, t, r);
			case "TSRestType": return kn(e, t, r);
			case "TSOptionalType": return [r("typeAnnotation"), "?"];
			case "TSInterfaceDeclaration": return sr(e, t, r);
			case "TSTypeParameterDeclaration":
			case "TSTypeParameterInstantiation": return Gt(e, t, r, "params");
			case "TSTypeParameter": return On(e, t, r);
			case "TSAsExpression":
			case "TSSatisfiesExpression": return xn(e, t, r);
			case "TSArrayType": return Tn(r);
			...
			case "TSTypeQuery": return _n(e, r);
			case "TSIndexSignature": return ca(e, t, r);
			case "TSTypePredicate": return wn(e, r);
			case "TSNonNullExpression": return [r("expression"), "!"];
			case "TSImportType": return [
				vt(e, t, r),
				n.qualifier ? [".", r("qualifier")] : "",
				Gt(e, t, r, "typeArguments")
			];
			case "TSLiteralType": return r("literal");
			case "TSIndexedAccessType": return Bn(e, t, r);
			case "TSTypeOperator": return [
				n.operator,
				" ",
				r("typeAnnotation")
			];
			case "TSMappedType": return na(e, t, r);
			case "TSMethodSignature": return la(e, t, r);
			case "TSNamespaceExportDeclaration": return [
				"export as namespace ",
				r("id"),
				t.semi ? ";" : ""
			];
			case "TSEnumDeclaration": return hn(e, r);
			case "TSEnumBody": return qs(e, t, r);
			case "TSEnumMember": return gn(e, r);
			...
			case "TSModuleDeclaration": return ma(e, t, r);
			case "TSConditionalType": return ur(e, t, r);
			case "TSInferType": return bn(e, t, r);
			case "TSIntersectionType": return Pn(e, t, r);
			case "TSUnionType": return un(e, t, r);
			case "TSFunctionType":
			case "TSCallSignatureDeclaration":
			case "TSConstructorType":
			case "TSConstructSignatureDeclaration": return Sn(e, t, r);
			case "TSTupleType": return tr(e, t, r);
			case "TSTypeReference": return [r("typeName"), Gt(e, t, r, "typeArguments")];
			case "TSTypeAnnotation": return an(e, t, r);
			case "TSEmptyBodyFunctionExpression": return Dn(e, t, r);
			case "TSJSDocAllType": return "*";
			case "TSJSDocUnknownType": return "?";
			case "TSJSDocNullableType": return Us(e, r, "?");
			case "TSJSDocNonNullableType": return Us(e, r, "!");
			default: throw new Qe(n, "TypeScript");
		}
	}
}
function cD(e, t, r, n) {
...
function yD(e, t, r) {
	...
	switch (n.type) {
		...
		case "NumericLiteral": return da(e) ? JSON.stringify(String(n.value)) : JSON.stringify(n.value);
		case "Identifier": return da(e) ? JSON.stringify(n.name) : n.name;
		case "TemplateLiteral": return r(["quasis", 0]);
		case "TemplateElement": return JSON.stringify(n.value.cooked);
		default: throw new Qe(n, "JSON");
	}
}
function da(e) {
