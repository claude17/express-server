...
function D(t, e = {}) {
	return $(t), ye(e.expandedStates, !0), {
		type: oe,
		id: e.id,
		contents: t,
		break: !!e.shouldBreak,
...
function zl(t, e) {
	let s = e === "\"" ? "'" : "\"";
	return e + E(0, t, Vl, (n, i, o) => i ? i === s ? s : n : o === e ? "\\" + o : o) + e;
}
function jl(t, e) {
...
function Xe(t) {
	...
	return Qe = Xe.prototype = t ?? Object.create(null), new Xe();
}
function Hr(t) {
	return Xe(t);
}
...
`);
	...
	let r = Object.create(null), n = E(0, t, On, "").replace(An, "").trimEnd(), i;
	for (; i = On.exec(t);) {
		let o = E(0, i[2], oc, "");
...
function Jr(t) {
	...
	let { pragmas: r, comments: n } = qn(Rn(t));
	return {
		shebang: e,
		text: t,
		pragmas: r,
...
function Wn(t) {
	let { shebang: e, text: s, pragmas: r, comments: n } = Jr(t), i = In(s), o = Ln({
		pragmas: {
			[Bn]: "",
			...r
		},
...
function bi(t, e, s) {
	...
	if (n && Xn(n) && (r.groups.length === 1 || r.groups.length > 0 && r.groups[0].type === "value-comma_group" && r.groups[0].groups.length > 0 && r.groups[0].groups[0].type === "value-word" && r.groups[0].groups[0].value.startsWith("data:"))) return [
		r.open ? s("open") : "",
		Y(",", i),
		r.close ? s("close") : ""
	];
	...
	let o = t.map(({ node: g, isLast: b, index: d }) => {
		...
		return m;
	}, "groups"), u = li(r, n), a = pi(r, n), l = ts(t, e), f = a || l && !u, h = a || u, c = D([
		r.open ? s("open") : "",
		L([M, Y(C, o)]),
		M,
		r.close ? s("close") : ""
...
function Cc(t, e, s) {
	...
	switch (r.type) {
		...
		case "css-rule": return [
			...
			r.nodes ? [
				r.selector?.type === "selector-unknown" && Le(r.selector.value) ? C : r.selector ? " " : "",
				"{",
				r.nodes.length > 0 ? L([T, De(t, e, s)]) : "",
				T,
				"}",
				Zn(r) ? ";" : ""
			] : ";"
		...
		case "css-decl": {
			...
			return l = ai(r) ? on(l) : l, !u && Le(o) && !t.call(() => is(t), "value", "group", "group") && (l = L([T, le(l)])), [
				E(0, r.raws.before, /[\s;]/gu, ""),
				n.type === "css-atrule" && n.variable || Kn(t) ? r.prop : Ie(r.prop),
				o.startsWith("//") ? " " : "",
				o,
				r.extend || a ? "" : " ",
				...
				r.nodes ? [
					...
					M,
					"}"
				] : ii(r) && !n.raws.semicolon && e.originalText[R(r) - 1] !== ";" ? "" : e.__isHTMLStyleAttribute && t.isLast ? Ct(";") : ";"
			];
		}
		case "css-atrule": {
			...
			return [
				"@",
				es(r) || r.name.endsWith(":") || Mt(r) ? r.name : Ie(r.name),
				r.params ? [es(r) ? "" : Mt(r) ? r.raws.afterName === "" ? "" : r.name.endsWith(":") ? " " : /^\s*\n\s*\n/u.test(r.raws.afterName) ? [T, T] : /^\s*\n/u.test(r.raws.afterName) ? T : " " : " ", typeof r.params == "string" ? r.params : s("params")] : "",
				r.selector ? L([" ", s("selector")]) : "",
				r.value ? D([
					" ",
					s("value"),
					Je(r, e) ? ui(r) ? " " : C : ""
				...
				r.nodes ? [
					Je(r, e) ? "" : r.selector && !r.selector.nodes && typeof r.selector.value == "string" && Le(r.selector.value) || !r.selector && typeof r.params == "string" && Le(r.params) ? C : " ",
					"{",
					L([r.nodes.length > 0 ? M : "", De(t, e, s)]),
					M,
					"}"
		...
		case "media-type": return _e(V(r.value, e));
		case "media-feature-expression": return r.nodes ? [
			"(",
			...t.map(s, "nodes"),
			")"
		] : r.value;
		case "media-feature": return Ie(V(E(0, r.value, / +/gu, " "), e));
		case "media-colon": return [r.value, " "];
		case "media-value": return _e(V(r.value, e));
		case "media-keyword": return V(r.value, e);
		case "media-url": return V(E(0, E(0, r.value, /^url\(\s+/giu, "url("), /\s+\)$/gu, ")"), e);
		case "media-unknown": return r.value;
		case "selector-root": return D([we(t, "custom-selector") ? [t.findAncestor((n) => n.type === "css-atrule").customSelector, C] : "", Y([",", we(t, [
			"extend",
			"custom-selector",
			"nest"
		]) ? C : T], t.map(s, "nodes"))]);
		case "selector-selector": return D((r.nodes.length > 2 ? L : (i) => i)(t.map(s, "nodes")));
		case "selector-comment": return r.value;
		case "selector-string": return V(r.value, e);
		case "selector-tag": return [r.namespace ? [r.namespace === !0 ? "" : r.namespace.trim(), "|"] : "", t.previous?.type === "selector-nesting" ? r.value : _e(Hn(t, r.value) ? r.value.toLowerCase() : r.value)];
		case "selector-id": return ["#", r.value];
		case "selector-class": return [".", _e(V(r.value, e))];
		case "selector-attribute": return [
			"[",
			r.namespace ? [r.namespace === !0 ? "" : r.namespace.trim(), "|"] : "",
			r.attribute.trim(),
			r.operator ?? "",
			r.value ? gi(V(r.value.trim(), e), e) : "",
			r.insensitive ? " i" : "",
			"]"
		];
		case "selector-combinator":
			if (r.value === "+" || r.value === ">" || r.value === "~" || r.value === ">>>") {
				let o = t.parent;
				return [
					o.type === "selector-selector" && o.nodes[0] === r ? "" : C,
					r.value,
					t.isLast ? "" : " "
				];
			}
			return [r.value.trim().startsWith("(") ? C : "", _e(V(r.value.trim(), e)) || C];
		case "selector-universal": return [r.namespace ? [r.namespace === !0 ? "" : r.namespace.trim(), "|"] : "", r.value];
		case "selector-pseudo": return [Ie(r.value), ce(r.nodes) ? D([
			"(",
			L([M, Y([",", C], t.map(s, "nodes"))]),
			M,
			")"
		]) : ""];
		...
		case "value-comment": return e.originalText.slice(P(r), R(r));
		case "value-comma_group": return di(t, e, s);
		...
		case "value-number": return [ns(r.value), ss(r.unit)];
		case "value-operator": return r.value;
		case "value-word": return r.isColor && r.isHex || jn(r.value) ? r.value.toLowerCase() : r.value;
		case "value-colon": {
			let { previous: n } = t;
			return D([r.value, typeof n?.value == "string" && n.value.endsWith("\\") || qe(t, "url") ? "" : C]);
		}
		case "value-string": return Nt(r.raws.quote + r.value + r.raws.quote, e);
...
function Yr(t) {
	return t.type === "paren_group" && !t.open && !t.close && t.groups.length === 1 || t.type === "comma_group" && t.groups.length === 1 ? Yr(t.groups[0]) : t.type === "paren_group" || t.type === "comma_group" ? {
		...t,
		groups: t.groups.map(Yr)
	} : t;
}
function fl(t, e) {
...
function Uy(t, e) {
	...
	s.text = t;
	return te(fl(s, e), "value-", /^selector-/u);
}
function $y(t) {
	return Fy.has(t);
}
...
function gl(t, e) {
	if (Se(t)) {
		...
		if (e.parser === "less" && t.type === "css-decl" && r.startsWith("extend(") && (t.extend || (t.extend = t.raws.between === ":"), t.extend && !t.selector && (delete t.value, t.selector = se(r.slice(7, -1)))), t.type === "css-atrule") {
			if (e.parser === "less") {
				if (t.mixin) return t.selector = se(t.raws.identifier + t.name + t.raws.afterName + t.raws.params), delete t.params, t;
		...
		if (t.type === "css-atrule" && n.length > 0) {
			...
			return i === "warn" || i === "error" ? (t.params = {
				type: "media-unknown",
				value: n
			}, t) : i === "extend" || i === "nest" ? (t.selector = se(n), delete t.params, t) : i === "at-root" ? (/^\(\s*(?:without|with)\s*:.+\)$/su.test(n) ? t.params = de(n, e) : (t.selector = se(n), delete t.params), t) : pl(o) ? (t.import = !0, delete t.filename, t.params = de(n, e), t) : [
				"namespace",
				"supports",
				"if",
				"else",
				...
				"define-mixin",
				"add-mixin"
			].includes(i) ? (n = n.replace(/(\$\S+?)(\s+)?\.{3}/u, "$1...$2"), n = n.replace(/^(?!if)([^"'\s(]+)(\s+)\(/u, "$1($2"), t.value = de(n, e), delete t.params, t) : ["media", "custom-media"].includes(o) ? n.includes("#{") ? {
				type: "media-unknown",
				value: n
			} : (t.params = Ea(n), t) : (t.params = n, t);
		}
	}
	return t;
}
function Js(t, e, s) {
	...
	try {
		...
		throw typeof l != "number" ? o : ma(`${u}: ${a}`, {
			loc: { start: {
				line: l,
				column: f
			} },
	...
	return s.originalText = e, i = gl(te(i, "css-"), s), Xr(i, e), r && (i.frontMatter = {
		...r,
		type: "front-matter",
		source: {
...
var init_postcss = __esmMin((() => {
	...
	Sl = Object.getOwnPropertyNames;
	kl = Object.getPrototypeOf, Tl = Object.prototype.hasOwnProperty;
	w = (t, e) => () => (e || t((e = { exports: {} }).exports, e), e.exports), sn = (t, e) => {
		for (var s in e) Vr(t, s, {
			get: e[s],
			enumerable: !0
		});
	}, Al = (t, e, s, r) => {
		if (e && typeof e == "object" || typeof e == "function") for (let n of Sl(e)) !Tl.call(t, n) && n !== s && Vr(t, n, {
			get: () => e[n],
			enumerable: !(r = El(e, n)) || r.enumerable
		});
		return t;
	};
	Te = (t, e, s) => (s = t != null ? bl(kl(t)) : {}, Al(e || !t || !t.__esModule ? Vr(s, "default", {
		value: t,
		enumerable: !0
	}) : s, t));
	Oi = w((ux, os) => {
...
`);
	...
	Ht = w((dx, ls) => {
		"use strict";
		ls.exports.isClean = Symbol("isClean");
		ls.exports.my = Symbol("my");
	});
	ut = w((mx, Li) => {
		"use strict";
...
` ? (s = 1, r += 1) : s += 1;
			...
			rangeBy(e = {}) {
				let s = "document" in this.source.input ? this.source.input.document : this.source.input.css, r = {
					...
					offset: ee(s, this.source.start)
				}, n = this.source.end ? {
					column: this.source.end.column + 1,
					line: this.source.end.line,
					offset: typeof this.source.end.offset == "number" ? this.source.end.offset : ee(s, this.source.end) + 1
				} : {
					column: r.column + 1,
					line: r.line,
					offset: r.offset + 1
...
`), s = new Array(e.length), r = 0;
		...
		var Be = class {
			...
			error(e, s, r, n = {}) {
				...
				return f ? l = new Ji(e, f.endLine === void 0 ? f.line : {
					column: f.column,
					line: f.line
				}, f.endLine === void 0 ? f.column : {
					column: f.endColumn,
					line: f.endLine
				}, f.source, f.file, n.plugin) : l = new Ji(e, o === void 0 ? s : {
					column: r,
					line: s
				}, o === void 0 ? r : {
					column: i,
					...
					offset: a,
					source: this.css
				}, this.file && (Kt && (l.input.url = Kt(this.file).toString()), l.input.file = this.file), l;
			}
		...
		to.exports = Be;
		Be.default = Be;
		ds && ds.registerInput && ds.registerInput(Be);
	});
	Qt = w((kx, so) => {
		"use strict";
...
`,
			...
			function H(W) {
				...
				switch (i = r.charCodeAt(p), i) {
					...
					case 40:
						...
						} else a = r.indexOf(")", p + 1), o = r.slice(p, a + 1), a === -1 || Qc.test(o) ? f = [
							"(",
							"(",
							p
						] : (f = [
					...
					case 34:
						...
						break;
					case 64:
						Jt.lastIndex = p + 1, Jt.test(r), Jt.lastIndex === 0 ? a = r.length - 1 : a = Jt.lastIndex - 2, f = [
							"at-word",
							r.slice(p, a + 1),
							p,
							a
					...
					case 92:
						...
						break;
					default:
						i === 47 && r.charCodeAt(p + 1) === 42 ? (a = r.indexOf("*/", p + 2) + 1, a === 0 && (n || A ? a = r.length : O("comment")), f = [
							"comment",
							r.slice(p, a + 1),
							p,
							a
						], p = a) : (Zt.lastIndex = p + 1, Zt.test(r), Zt.lastIndex === 0 ? a = r.length - 1 : a = Zt.lastIndex - 2, f = [
							"word",
							r.slice(p, a + 1),
							p,
							a
	...
	tr = w((Nx, yo) => {
		"use strict";
		var Xc = Qt(), Jc = Me(), Zc = ft(), ef = $e(), ho = Xt(), tf = er(), mo = {
			empty: !0,
			space: !0
		};
		function rf(t) {
		...
		var vs = class {
			constructor(e) {
				this.input = e, this.root = new ef(), this.current = this.root, this.spaces = "", this.semicolon = !1, this.createTokenizer(), this.root.source = {
					input: e,
					start: {
						column: 1,
						line: 1,
...
`));
				...
				if (e[0] === "comment" && e[1].startsWith('/*')) return e[0] = "word", e[1] = e[1].slice(1), t[1] = "//", this.tokenizer.back(e), xs.exports.isInlineComment.bind(this)(t);
			}
			return !1;
		} };
	});
		...
		function dt(t, e) {
			...
			if (s) {
				...
				for (let n of s) {
					let i = {
						...n,
						__proto__: Cf.prototype
					};
					i.map && (i.map = {
						...i.map,
						__proto__: Nf.prototype
					}), e.push(i);
				}
			}
	...
	As = w((Qx, Ho) => {
		"use strict";
		var qf = fe(), Lf = sr(), Df = bs(), Mf = ht(), Vo = nr(), Bf = $e(), Uf = it(), { isClean: Q, my: Ff } = Ht();
		Ss();
		var $f = {
			atrule: "AtRule",
			comment: "Comment",
		...
		var Ts = {}, he = class t {
			...
			constructor(e, s, r) {
				...
				this.result = new Vo(e, n, r), this.helpers = {
					...Ts,
					postcss: Ts,
					result: this.result
			...
			sync() {
				...
				for (let e of this.plugins) if (gt(this.runOnRoot(e))) throw this.getAsyncError();
				if (this.prepareVisitors(), this.hasListener) {
					let e = this.result.root;
		...
		Ho.exports = he;
		he.default = he;
		Bf.registerLazyResult(he);
		Lf.registerLazyResult(he);
	});
	Qo = w((Jx, Ko) => {
		"use strict";
		var Yf = bs(), Vf = ht(), zf = nr(), jf = it();
		Ss();
		var wt = class {
			get content() {
	...
	Jo = w((Zx, Xo) => {
		...
		Xo.exports = Ee;
		Ee.default = Ee;
		Xf.registerProcessor(Ee);
		Hf.registerProcessor(Ee);
	});
	ir = w((e_, ia) => {
		"use strict";
...
https://evilmartians.com/chronicles/postcss-8-plugin-migration`));
		...
		S.fromJSON = ep;
		S.list = sp;
		S.comment = (t) => new ea(t);
		S.atRule = (t) => new Zo(t);
		S.decl = (t) => new ta(t);
		S.rule = (t) => new na(t);
		S.root = (t) => new sa(t);
		S.document = (t) => new ra(t);
		S.CssSyntaxError = Zf;
		S.Declaration = ta;
		S.Container = Jf;
		S.Processor = Os;
			...
			function ne(A) {
				...
				switch (i = r.charCodeAt(d), i) {
					...
					case 40:
						...
						} else o = r.indexOf(")", d + 1), a = r.slice(d, o + 1), o === -1 || cp.test(a) ? g = [
							"(",
							"(",
							d
						] : (g = [
					...
					case 34:
						...
						break;
					case 64:
						or.lastIndex = d + 1, or.test(r), or.lastIndex === 0 ? o = r.length - 1 : o = or.lastIndex - 2, g = [
							"at-word",
							r.slice(d, o + 1),
							d,
							o
					...
					case 92:
						...
						break;
					default:
						c = r.charCodeAt(d + 1), i === 35 && c === 123 ? (o = d, H(), a = r.slice(d, o + 1), g = [
							"word",
							a,
							d,
							o
						], d = o) : i === 47 && c === 42 ? (o = r.indexOf("*/", d + 2) + 1, o === 0 && (n || k ? o = r.length : O("comment")), g = [
							"comment",
							r.slice(d, o + 1),
							d,
							o
						], d = o) : i === 47 && c === 47 ? (ur.lastIndex = d + 1, ur.test(r), ur.lastIndex === 0 ? o = r.length - 1 : o = ur.lastIndex - 2, a = r.slice(d, o + 1), g = [
							"comment",
							a,
							d,
							o,
							"inline"
						], d = o) : (ar.lastIndex = d + 1, ar.test(r), ar.lastIndex === 0 ? o = r.length - 1 : o = ar.lastIndex - 2, g = [
							"word",
							r.slice(d, o + 1),
							d,
							o
...
`)) break;
	...
	qs = w((Is) => {
		...
		vt.prototype = Object.create(ya.default.prototype);
		vt.constructor = ya.default;
		vt.prototype.walk = function(e, s) {
	...
	xa = w((xt) => {
		...
		xt.parseMediaFeature = va;
		xt.parseMediaQuery = Ds;
		xt.parseMediaList = Sp;
		var ga = wa(Rs()), Ls = wa(qs());
		function wa(t) {
			return t && t.__esModule ? t : { default: t };
		}
		function va(t) {
			...
			for (var f = 0; f < l.length; f++) {
				...
				if ((h === "'" || h === "\"") && (s[n].isCalculationEnabled === !0 ? (s.push({
					...
					character: h
				}), n++) : s[n].mode === "string" && s[n].character === h && l[f - 1] !== "\\" && (s.pop(), n--)), h === "{" ? (s.push({
					mode: "interpolation",
		...
		function Ds(t) {
			...
			for (var u = 0; u < t.length; u++) {
				...
				n ? (i.value += a, (a === "{" || a === "(") && r++, (a === ")" || a === "}") && r--) : a.search(/\s/) !== -1 ? i.before += a : (a === "(" && (i.type = "media-feature-expression", r++), i.value = a, i.sourceIndex = e + u, n = !0), n && r === 0 && (a === ")" || u === t.length - 1 || t[u + 1].search(/\s/) !== -1) && ([
					...
					"only",
					"and"
				].indexOf(i.value) !== -1 && (i.type = "keyword"), i.type === "media-feature-expression" && (i.nodes = va(i.value, i.sourceIndex)), s.push(Array.isArray(i.nodes) ? new Ls.default(i) : new ga.default(i)), i = o(), n = !1);
			}
		...
		function Sp(t) {
			...
			return e.push(new Ls.default({
				type: "media-query",
				value: c.trim(),
				sourceIndex: s + g.length,
				nodes: Ds(c, s),
				before: g,
				after: /(\s*)$/.exec(c)[1]
			})), e;
	...
	_a = w((Ms) => {
		...
		function Cp(t) {
			return new Tp.default({
				nodes: (0, Ap.parseMediaList)(t),
			...
			for (var e = [], s = t.css.valueOf(), r = void 0, n = void 0, i = void 0, o = void 0, u = void 0, a = void 0, l = void 0, f = void 0, h = void 0, c = void 0, g = void 0, b = s.length, d = -1, p = 1, m = 0, y = function(O, q) {
				...
				switch (r = s.charCodeAt(m), r === _t && (d = m, p += 1), r) {
					...
					case Vd:
						...
						break;
					case em:
						Tr.lastIndex = m + 1, Tr.test(s), Tr.lastIndex === 0 ? n = s.length - 1 : n = Tr.lastIndex - 2, e.push([
							"at-word",
							s.slice(m, n + 1),
							p,
							m - d,
					...
					case Ws:
						...
						r = s.charCodeAt(n + 1), l && r !== nu && r !== Gs && r !== _t && r !== Vs && r !== zs && r !== Ys && (n += 1), e.push([
							"word",
							s.slice(m, n + 1),
							p,
							m - d,
...
`), u = o.length - 1, u > 0 ? (f = p + u, h = n - o[u].length) : (f = p, h = d), e.push([
							"comment",
							a,
							p,
							m - d,
							...
							n - h,
							m
						]), d = h, p = f, m = n) : (Ar.lastIndex = m + 1, Ar.test(s), Ar.lastIndex === 0 ? n = s.length - 1 : n = Ar.lastIndex - 2, e.push([
							"word",
							s.slice(m, n + 1),
							p,
							m - d,
	...
	du = w((Cr, hu) => {
		...
		})(), nm = I(Us()), js = I(Fs()), am = I($s()), lm = I(Pa()), Hs = I(Ia()), pm = I(Da()), dm = I(Ba()), ym = I(Fa()), wm = I(Wa()), xm = I(Ya()), bm = I(za()), Sm = I(Ha()), Tm = I(Qa()), Om = I(Ja()), Nm = I(eu()), Rm = I(ru()), pu = I(fu()), Lm = Dm(B());
		function Dm(t) {
			if (t && t.__esModule) return t;
			var e = {};
			if (t != null) for (var s in t) Object.prototype.hasOwnProperty.call(t, s) && (e[s] = t[s]);
		...
		Cr.default = (function() {
			function t(e) {
				...
				return this.root.append(s), this.current = s, this.lossy ? this.tokens = (0, pu.default)({
					safe: e.safe,
					css: e.css.trim()
				}) : this.tokens = (0, pu.default)(e), this.loop();
			}
			return t.prototype.attribute = function() {
				...
				var c = (0, Rm.default)((0, am.default)((0, nm.default)([
					[0],
					l,
					f
				])));
				c.forEach(function(g, b) {
					...
					~l.indexOf(g) ? m = new pm.default({
						...
						source: {
							start: {
								line: n.currToken[2],
								column: n.currToken[3] + g
							},
							end: {
								line: n.currToken[4],
								column: n.currToken[3] + (d - 1)
							}
						},
						sourceIndex: n.currToken[6] + c[b]
					}) : ~f.indexOf(g) ? m = new ym.default({
						value: p.slice(1),
						source: {
							start: {
								line: n.currToken[2],
	...
	yu = w((Nr, mu) => {
		...
		Nr.default = (function() {
			function t(e) {
				return Gm(this, t), this.func = e || function() {}, this;
			}
			return t.prototype.process = function(s) {
				var r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, n = new $m.default({
					css: s,
					error: function(o) {
						throw new Error(o);
					},
...
` ? (r = 1, n += 1) : r += 1;
	...
	Ju = w((Z_, Xu) => {
		...
		Xu.exports = function(e, s) {
			s = s || {};
			let r = [], n = e.valueOf(), i = n.length, o = -1, u = 1, a = 0, l = 0, f = null, h, c, g, b, d, p, y, v, O, q, H;
			function ne(A) {
				throw new Qu(`Unclosed ${A} at line: ${u}, column: ${a - o}, token: ${a}`);
			}
			for (; a < i;) {
				switch (h = n.charCodeAt(a), h === 10 && (o = a, u += 1), h) {
					...
					case 125:
						...
						break;
					case 40:
						l++, f = !f && l === 1 && r.length > 0 && r[r.length - 1][0] === "word" && r[r.length - 1][1] === "url", r.push([
							"(",
							"(",
							u,
							a - o,
					...
					case 34:
						...
						break;
					case 64:
						Wr.lastIndex = a + 1, Wr.test(n), Wr.lastIndex === 0 ? c = n.length - 1 : c = Wr.lastIndex - 2, r.push([
							"atword",
							n.slice(a, c + 1),
							u,
							a - o,
...
`), d = b.length - 1, d > 0 ? (y = u + d, v = c - b[d].length) : (y = u, v = o), r.push([
								"comment",
								p,
								u,
								a - o,
						...
						} else if (h === 35 && !dy.test(n.slice(a + 1, a + 2))) c = a + 1, r.push([
							"#",
							n.slice(a, c),
							u,
							a - o,
	...
	nl = w((rb, sl) => {
		...
		sl.exports = class {
			...
			comment() {
				...
				this.options.loose && s.startsWith("//") && (s = s.substring(2), e = !0), r = new _y({
					value: s,
					inline: e,
					source: {
						start: {
			...
			parenOpen() {
				...
				if (e && this.error("Expected closing parenthesis", r), n = this.current.last, n && n.type === "func" && n.unbalanced < 0 && (n.unbalanced = 0, this.current = n), this.current.unbalanced++, this.newNode(new tl({
					value: r[1],
					source: {
						start: {
							line: r[2],
					...
					this.position !== this.tokens.length - 1 && (this.position++, this.newNode(new rl({
						value: o,
						source: {
							start: u,
							end: {
			...
			string() {
				...
				n && (i = s.match(r)[0], s = s.slice(1, s.length - 1)), o = new ky({
					value: s,
					source: {
						start: {
							line: e[2],
	...
	bt = (t, e) => (s, r, ...n) => s | 1 && r == null ? void 0 : (e.call(r) ?? r[t]).apply(r, n);
	Ol = String.prototype.replaceAll ?? function(t, e) {
		return t.global ? this.replace(t, e) : this.split(t).join(e);
	}, E = bt("replaceAll", function() {
	...
	Rl = () => {}, K = Rl;
	je = "string", He = "array", Et = "cursor", ie = "indent", Ae = "align", St = "trim", oe = "group", ae = "fill", me = "if-break", kt = "indent-if-break", Oe = "line-suffix", Tt = "line-suffix-boundary", X = "line", At = "label", Ce = "break-parent", Ot = new Set([
		Et,
		ie,
		Ae,
		St,
	...
	ue = Il;
	ql = (t) => new Intl.ListFormat("en-US", { type: "disjunction" }).format(t);
	...
	Pt = Symbol.for("PRETTIER_IS_FRONT_MATTER");
	Re = Hl;
	Ke = 3;
	ge = Ql;
	Xl = new Set([
	...
	_n = vn({
		...
		"media-query-list": _[1],
		"media-query": _[1],
		"media-type": _[0],
		"media-feature-expression": _[1],
		"media-feature": _[0],
		"media-colon": _[0],
		"media-value": _[0],
		"media-keyword": _[0],
		...
		"media-unknown": _[0],
		"selector-root": _[1],
		"selector-selector": _[1],
		"selector-comment": _[0],
		"selector-string": _[0],
		"selector-tag": _[0],
		"selector-id": _[0],
		"selector-class": _[0],
		"selector-attribute": _[0],
		"selector-combinator": _[1],
		"selector-universal": _[0],
		"selector-pseudo": _[1],
		"selector-nesting": _[0],
		"selector-unknown": _[0],
		"value-value": _[2],
		"value-root": _[2],
		"value-comment": _[0],
		...
		"value-string": _[0],
		"value-atword": _[0],
		"value-unicode-range": _[0],
		"value-unknown": _[0]
	});
	Kr = rc;
	It = Rt(" 	"), bn = Rt(",; 	"), qt = Rt(/[^\n\r]/u);
	P = (t) => t.source?.startOffset, R = (t) => t.source?.endOffset;
	nc = /\*\/$/, ic = /^\/\*\*?/, Nn = /^\s*(\/\*\*?(.|\r?\n)*?\*\/)/, oc = /(^|\s+)\/\/([^\n\r]*)/g, An = /^(\r?\n)+/, ac = /(?:^|\r?\n) *(@[^\n\r]*?) *\r?\n *(?![^\n\r@]*\/\/[^]*)([^\s@][^\n\r@]+?) *\r?\n/g, On = /(?:^|\r?\n) *@(\S+) *([^\n\r]*)/g, uc = /(\r?\n|^) *\* ?/g, Pn = [];
...
` : "") + Wn(s);
	...
	yi = /(["'])(?:(?!\1)[^\\]|\\.)*\1/gsu, wc = new RegExp(yi.source + `|(${/[$@]?[_a-z\u0080-\uFFFF][\w\u0080-\uFFFF-]*/giu.source})?(${/(?:\d*\.\d+|\d+\.?)(?:e[+-]?\d+)?/giu.source})(${/[a-z]+/giu.source})?`, "giu");
	vi = (t) => t === `
` || t === "\r" || t === "\u2028" || t === "\u2029";
	Gt = vc;
	Yt = xc;
...
//#endregion
init_postcss();
export { _l as default, Si as languages, postcss_exports as n, Ti as options, en as parsers, Hy as printers, init_postcss as t };
